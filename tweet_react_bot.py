...
if currentDay_price > previousDay_price : #and currentDay_price > 0 :
        ...
        print(' Market collapsed by ' + str(nifty) + " % , The bear run has started. ")
        message = ' Market collapsed by ' + str(nifty) + ' % , The bear run has started. '                            
elif    previousDay_price < currentDay_price and currentDay_price > previousDay_price :                                             
